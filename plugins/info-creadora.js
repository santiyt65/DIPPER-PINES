...
enlace = official[0][0] == String(contact[0]) ? 'https://github.com/santiyt65' : official[1][0] == String(contact[0]) ? 'https://github.com/santiyt65' : official[2][0] == String(contact[0]) ? 'https://github.com/santiyt65' : official[3][0] == String(contact[0]) ? 'https://github.com/santiyt65' : md 
